...
class SocietiesControllerTest < ActionController::TestCase
  ...
  test "should create society" do
    assert_difference('Society.count') do
      post :create, society: { description: @society.description, membershipFee: @society.membershipFee, name: @society.name, verified: @society.verified }
    end
  ...
  test "should update society" do
    patch :update, id: @society, society: { description: @society.description, membershipFee: @society.membershipFee, name: @society.name, verified: @society.verified }
    assert_redirected_to society_path(assigns(:society))
  end
